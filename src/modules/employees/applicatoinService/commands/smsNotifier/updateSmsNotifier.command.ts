...
import { UpdateSmsNotifierProps } from 'src/modules/employees/domain/types/smsNotifier.type';
...
export class UpdateSmsNotifierCommandHandler
  implements ICommandHandler<UpdateSmsNotifierCommand>
{
  constructor(
