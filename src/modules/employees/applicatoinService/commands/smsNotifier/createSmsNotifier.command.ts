...
import { CreateSmsNotifierProps } from 'src/modules/employees/domain/types/smsNotifier.type';
...
export class CreateSmsNotifierCommandHandler
  implements ICommandHandler<CreateSmsNotifierCommand>
{
  constructor(
