...
@Injectable()
export class VideoDeviceDataQueueService {
  private queue: QueueService<VideoDeviceDataQueueMsgDto>;
  constructor(
    ...
    this.queue = new QueueService<VideoDeviceDataQueueMsgDto>().createQueue(
